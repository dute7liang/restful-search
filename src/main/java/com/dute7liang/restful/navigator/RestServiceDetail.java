...
import com.dute7liang.restful.common.RequestHelper;
import com.dute7liang.utils.JsonUtils;
...
public class RestServiceDetail extends JBPanel/*WithEmptyText*/{
    private static final Color TEXT_AREA_BACKGROUND = new JBColor(new Color(0xFFFFFF), new Color(0x2B2B2B));
    private static final Color TEXT_AREA_FOREGROUND = new JBColor(new Color(0x000000), new Color(0xBBBBBB));
    private static final Color TEXT_AREA_SELECTION = new JBColor(new Color(0xA6D2FF), new Color(0x28437F));
    private static final Color TEXT_AREA_LINE_HIGHLIGHT = new JBColor(new Color(0xFCFAED), new Color(0x323232));
    ...
    public void addRequestTabbedPane(String title, RSyntaxTextArea jTextArea) {
        jTextArea.setBackground(TEXT_AREA_BACKGROUND);
        jTextArea.setForeground(TEXT_AREA_FOREGROUND);
        jTextArea.setSelectionColor(TEXT_AREA_SELECTION);
        jTextArea.setCurrentLineHighlightColor(TEXT_AREA_LINE_HIGHLIGHT);
