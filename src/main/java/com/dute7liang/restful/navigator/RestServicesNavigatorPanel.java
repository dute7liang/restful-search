...
import com.dute7liang.utils.RestServiceDataKeys;
...
public class RestServicesNavigatorPanel extends SimpleToolWindowPanel implements DataProvider {
    ...
    public RestServicesNavigatorPanel(Project project, SimpleTree tree) {
        this(project, tree, new RestServiceDetail());
    }

    public RestServicesNavigatorPanel(Project project, SimpleTree tree, RestServiceDetail restServiceDetail) {
        super(true, true);
