...
import com.dute7liang.restful.common.KtFunctionHelper;
import com.dute7liang.restful.common.PsiMethodHelper;
...
public class RestServiceStructure extends SimpleTreeStructure {
    ...
    public RestServiceStructure(Project project,
                                ...
                                RestServiceDetail restServiceDetail,
                                SimpleTree tree) {
        myProject = project;
        myProjectsManager = projectsManager;
        myTree = tree;
        myRestServiceDetail = restServiceDetail;
...
/*        if (!ModalityState.current().equals(ModalityState.any()) && myProject.isInitialized()) {
        ...
        List<RestServiceProject> projects = myProjectsManager.getServiceProjects();
